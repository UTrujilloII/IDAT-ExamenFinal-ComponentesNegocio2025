...
import pe.edu.idat.biblioteca.exception.FechaBeforeException;
...
public class PrestamosServiceImpl implements PrestamosService {
    ...
    public PrestamoResponse createPrestamo(PrestamoRequest prestamoRequest) {
        ...
        if(prestamoRequest.fechaEntrega().isBefore(LocalDate.now())){
            throw new FechaBeforeException("la fecha de entrega debe ser posterior al dia de hoy");
        }
